...
public class one_speci_park extends OpMode {
    ...
    public void init() {
        ...
        toSub
                .addPath(
                        ...
                        new BezierLine(
                                ...
                                new Point(35.792, 84.193, Point.CARTESIAN)
                        )
                )
        ...
        toPark
                .addPath(
                        ...
                        new BezierLine(
                                new Point(35.792, 84.193, Point.CARTESIAN),
                                new Point(25, 84.193, Point.CARTESIAN)
                        )
                )
                ...
                .addPath(
                        // Line 2
                        new BezierCurve(
                                new Point(34.176, 60.639, Point.CARTESIAN),
                                new Point(22.630, 60.408, Point.CARTESIAN),
                                new Point(14.779, 64.796, Point.CARTESIAN),
                                new Point(12.931, 41.935, Point.CARTESIAN)
                        )
                )
                ...
                .addPath(
                        ...
                        new BezierLine(
                                new Point(12.931, 41.935, Point.CARTESIAN),
                                new Point(12.700, 26.695, Point.CARTESIAN)
                        )
                )
                .setLinearHeadingInterpolation(Math.toRadians(270), Math.toRadians(270));
...
//        }
        ...
        if(first){
            startTime = System.currentTimeMillis();
            tempTime = System.currentTimeMillis() + 300;
        ...
        if((timer.elapsedTime() > 4) && (timer.elapsedTime() < 6)){
            if(thirdTime){
                extenderTarget = 16;
                thirdTime = false;
            }
        ...
        if((timer.elapsedTime() > 7 && timer.elapsedTime() < 8)){
            if (fourthTime){
        ...
        if (timer.elapsedTime() > 8 && timer.elapsedTime() < 10){
            intakeServo.setPower(1);
        }


        telemetry.addData("Start", startTime);
        telemetry.addData("Temp", tempTime + 5000);
