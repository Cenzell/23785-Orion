...
public class MotionSubsystem {
    ...
    public static double WI = .1;
    public static double WD = .1;
    public static double WF = .0001;
    ...
    public void init() {
        ...
        wristPID = new PIDFController(WP, WI, WD, WF); //TODO fix
    ...
    public void closeClaw(){
        Claw.setPosition(.2); //TODO find correct position
    ...
    public void setWrist(){
        ...
        // Apply power limits
        pidOutput = ((Math.min(Math.max(pidOutput, -1.0), 1.0))/2) + .5;
        telemetry.addData("wristPIDValue", pidOutput);
